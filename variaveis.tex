...
\program{Curso Tecnólogo em Sitemas para Internet}
\programen{Undergradute Program in Sitemas para Internet}
\degree{Tecnólogo}
\degreearea{Sitemas para Internet}
% Caso seja TSI:
...
\author{Murilo Nunes Marçal}  % Seu nome
\authorbib{Marçal, Murilo} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Integração e Entrega Contínua: Comparação de Funcionalidades entre Jenkins, GitLab CI e GitHub Actions} % Título do trabalho
\titleen{Continuous Integration and Deployment: Comparing Jenkins, GitLab CI, and GitHub Actions} % Título traduzido para inglês
\advisor{Hermano Pereira} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\evalboardmember{Murilo Nunes Marçal}{Universidade Tecnologica Federal do Paraná}
...
\PalavraChaveA{Entrega cont\'inua}%% Palavra-chave A
\PalavraChaveB{Integra\c{c}\~ao cont\'inua}%% Palavra-chave B
\PalavraChaveC{an\'alise de performance}%% Palavra-chave B
\PalavraChaveD{desenvolvimento e opera\c{c}\~oes}%% Palavra-chave D
%%\PalavraChaveE{GitLab}%% Palavra-chave E
...
\KeywordA{Continuous integration}%% Keyword A
\KeywordB{Continuous delivery}%% Keyword B
\KeywordC{Benchmarking}%% Keyword C
\KeywordD{DevOps}%% Keyword B
