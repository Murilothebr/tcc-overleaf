...
\title{Comparativo de Ferramentas para Integração Contínua: Análise de Complexidade e Performance} % Título do trabalho
\titleen{Comparison of Continuous Integration Tools: Analysis of Complexity and Performance} % Título traduzido para inglês
...
\PalavraChaveA{paoo}%% Palavra-chave A
